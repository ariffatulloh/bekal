...
PayloadResponseMyProfileDashboard _$PayloadResponseMyProfileDashboardFromJson(
  ...
  return _PayloadResponseMyProfileDashboard.fromJson(json);
}
...
mixin _$PayloadResponseMyProfileDashboard {
  ...
  @JsonKey(ignore: true)
  $PayloadResponseMyProfileDashboardCopyWith<PayloadResponseMyProfileDashboard>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PayloadResponseMyProfileDashboardCopyWith<$Res> {
  factory $PayloadResponseMyProfileDashboardCopyWith(
          PayloadResponseMyProfileDashboard value,
          $Res Function(PayloadResponseMyProfileDashboard) then) =
...
/// @nodoc
class _$PayloadResponseMyProfileDashboardCopyWithImpl<$Res>
    implements $PayloadResponseMyProfileDashboardCopyWith<$Res> {
  _$PayloadResponseMyProfileDashboardCopyWithImpl(this._value, this._then);

  final PayloadResponseMyProfileDashboard _value;
  // ignore: unused_field
  final $Res Function(PayloadResponseMyProfileDashboard) _then;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      alertUbahDataPribadi: alertUbahDataPribadi == freezed
          ? _value.alertUbahDataPribadi
          : alertUbahDataPribadi // ignore: cast_nullable_to_non_nullable
              as Alert?,
      alertHystoryTransaksi: alertHystoryTransaksi == freezed
...
/// @nodoc
@JsonSerializable()
class _$_PayloadResponseMyProfileDashboard
  ...
  factory _$_PayloadResponseMyProfileDashboard.fromJson(
          Map<String, dynamic> json) =>
      _$$_PayloadResponseMyProfileDashboardFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$_PayloadResponseMyProfileDashboardToJson(this);
  }
}
